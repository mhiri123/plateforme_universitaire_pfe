...
class ProceduresController with ChangeNotifier {
  ...
  List<String> steps = [
    ...
    "Sélectionner la demande à effectuer",
  ...
  List<String> stepsDetails = [
    ...
    "Étape 2 : L'utilisateur doit sélectionner le type de demande à effectuer, soit une réorientation ou un transfert selon son parcours.",
    "Étape 3 : L'utilisateur doit télécharger les documents nécessaires comme les relevés de notes, lettres de motivation, etc.",
    "Étape 4 : Une fois les documents téléchargés et vérifiés, l'utilisateur soumet sa demande pour traitement.",
    "Étape 5 : L'utilisateur peut suivre l'état de sa demande dans son tableau de bord personnel, avec des notifications à chaque étape.",
    "Étape 6 : Une fois la demande traitée, l'utilisateur reçoit un résultat et des instructions supplémentaires si la demande est acceptée.",
