...
class _DemandeReorientationApiService
  ...
  Future<List<DemandeReorientation>> listerMesDemandesReorientation(
    ...
    final _options = _setStreamType<List<DemandeReorientation>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/reorientation/demandes/etudiant/${id}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<dynamic> getStudentId(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/reorientation/demandes/${id}/student',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<DemandeReorientation> getDemandeDetails(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
